...
export default function Footer() {
  return <> 
       <footer className="h-[630px] bg-gray-100 w-[415px] md:h-44 md:w-full md:bg-gray-100 ">
       ...
       <ul className='flex justify-center mb-3 gap-4 items-center w-[415px] bg-gray-100  md:flex md:justify-center md:w-full h-28 md:gap-6'>
