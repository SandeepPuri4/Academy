  ...
  return <>
      ...
      <div className="mt-0 h-[400px] md:h-[510px] flex flex-col md:flex md:flex-row md:mt-24 ">
          <div className="mt-5 flex flex-col pl-2 md:mt-14">
            ...
            <div className=" w-full h-[220px] md:w-[700px]">
              
            <p className=" px-5 mt-4 font-[100px] text-stone-700 text-[17px] ">Enroll in our programs built with top university and industry partners, with dedicated mentorship and expert career guidance.,We partner with companies and individuals to address their unique needs, providing training and coaching that helps working professionals achieve their career goals</p>
            </div>
