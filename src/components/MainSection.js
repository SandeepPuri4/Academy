...
export default function MainSection() {
  ...
  return <>
      ...
      <div className="mt-0 h-[420px] md:h-[510px] flex flex-col md:flex md:flex-row md:mt-24 ">
          <div className="mt-5 h-[400px] flex flex-col md:mt-14">
            ...
            <div className=" w-[410px] mt-6 h-[180px] md:hidden">
              <p className=" text-[16px] px-10">Enroll in our programs built with top university</p>
              <p className="text-[16px] px-7">and industry partners, with dedicated mentorship </p>
              <p className="text-[16px] px-11">and expert career guidance.,We partner with</p>
            ...
            <div className=" mt-12 mx-auto md:mx-16">
