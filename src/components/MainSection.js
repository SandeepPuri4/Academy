  ...
  return <>
      ...
      <div className="mt-0  md:w-[50%]  md:h-[510px] flex flex-col md:flex md:flex-row md:mt-24 ">
          <div className="mt-5 flex flex-col pl-2 md:mt-14 mx-auto">
            <h1 className="text-[40px] text-green-950 font-semibold md:ml-44 md:text-[70px] md:w-[650px]">Get Skilled & Boost</h1>
            <h1  className="text-[40px] pl-14 text-green-950 font-semibold md:ml-[120px] md:text-[70px] md:w-[650px]">Your Career</h1>
