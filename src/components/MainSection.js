...
export default function MainSection() {
  return <>
         <div className="h-[250px] w-[310px] mt-2 mb-1 mx-auto md:hidden">
          <img src={logo} alt="logo"/>
         </div>
      <div className="w-full h-[510px] mt-2 flex flex-col md:flex md:flex-row md:mt-5 ">
        ...
        <div className="items-center pr- mt-12">
