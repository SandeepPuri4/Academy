  ...
  return <>
      ...
      <div className="mt-0  md:w-[50%]  md:h-[510px] flex flex-col md:flex md:flex-row md:mt-24 ">
          <div className="mt-5 flex flex-col pl-2 md:mt-14 mx-auto">
            <h1 className="text-[40px] text-green-950 pl-5 font-semibold md:ml-40 md:text-[70px] md:w-[650px]">Get Skilled & Boost</h1>
            <h1  className="text-[40px] pl-20 text-green-950 font-semibold md:ml-[120px] md:text-[70px] md:w-[650px]">Your Career</h1>
            ...
            <div className="md:ml-40 w-full mx-auto ">
              <button className="bg-green-600 mx-auto ml-28 mt-10 text-white px-7 py-2 rounded-3xl hover:bg-green-500] hover:bg-green-500 ">ENQUIRY NOW</button>
            </div>
          </div>
