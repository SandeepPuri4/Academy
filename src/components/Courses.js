...
export default function Courses() {
  ...
  return (
    <>
      <div className="mt-20 mx-auto h-36 w-[415px] md:w-full md:h-44 xl:h-48 md:mt-36">
        <div className="flex flex-col h-36 w-[100%] px-4 md:w-full md:h-60 md:flex md:flex-col items-center ">
          <h1 className="font-semibold text-[30px] mx-auto text-center text-org1 md:font-bold lg:text-[55px] md:text-[52px] md:justify-center">Our Best Courses</h1>
          <div className='w-[415px] h-72 md:hidden'>
            <p className="text-center text-white text-[16px] px-3">Each of our courses is designed to be easy to navigate up to date on the industry, to assist you with questions and help you find a job.</p>
          ...
          <p className="hidden md:block md:text-white text-[18px] ">to help you find a job.</p>
        </div>
      </div>
      
      <div className=' h-[415px] w-[415px] text-white mx-auto lg:h-[100rem] xl:h-[65rem] md:h-[105rem] md:w-full lg:w-full lg:mx-auto'>
